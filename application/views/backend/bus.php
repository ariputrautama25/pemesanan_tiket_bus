            ...
            <thead class="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php } ?>
                  <td align="center"><a href="<?= base_url('backend/bus/viewbus/'.$row['kd_bus'])?>" class="btn btn btn-info">Lihat</a></a>
                  <td align="center"><a href="<?= base_url('backend/bus/viewbus/'.$row['kd_bus'])?>" class="btn btn btn-warning">Edit</a></a>
                  <td align="center"><a href="<?= base_url('backend/bus/viewbus/'.$row['kd_bus'])?>" class="btn btn btn-danger">Hapus</a></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
